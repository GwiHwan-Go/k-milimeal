...
-- CreateIndex
CREATE UNIQUE INDEX "Like.hashtagId_userId_unique" ON "Like"("hashtagId", "userId");
...
-- AddForeignKey
ALTER TABLE "Like" ADD FOREIGN KEY ("hashtagId") REFERENCES "Hashtag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
